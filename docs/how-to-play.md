...
1. Place **four cards face-down in the middle** of the table as the display piles.
2. Deal the remaining cards evenly among all players.
3. Each player places their cards in a **face-down pile** in front of them.
4. Flip over the four middle cards to start the display.
...
- **Aces are low.** An ace can be played onto a two, but not onto a king.
- **Kings are high.** A king cannot be played onto an ace, and an ace cannot be played onto a king. The sequence does not wrap around.

## Running Out of Face-Down Cards

When your face-down pile is empty, flip your face-up pile over and continue playing from it.
